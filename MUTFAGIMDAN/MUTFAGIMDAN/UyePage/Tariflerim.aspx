<%@ Page Title="" Language="C#" MasterPageFile="~/UyePage/Profil.Master" AutoEventWireup="true" CodeBehind="Tariflerim.aspx.cs" Inherits="MUTFAGIMDAN.UyeResim.Tariflerim" %>
  ...
  <tbody>
    ...
    <tr >
      ...
      <td style="padding-left:0px; font-size:18px;" scope="col">
          <asp:Label ID="Label2" runat="server" Text='<%# Eval("TarifIsim")%>'></asp:Label>
      </td>
       ...
       <td style="padding-left:350px;  ">
           <br />
           <a href="/tarifguncelle.aspx?Uyeid=<%#Eval("Uyeid")%>&&Tarifid=<%#Eval("Tarifid") %>"><asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/images/update.png" Width="30px" /></a> 
         
       
       </td>
        
       <td style="padding-left:200px; ">
           <a href="/UyePage/Tariflerim.aspx?Uyeid=<%#Eval("Uyeid") %>&&Tarifid=<%#Eval("Tarifid") %>&islem=sil"> <asp:Image ID="Image1" runat="server" Height="30px" ImageUrl="~/images/delete.png" Width="30px" /></a>
