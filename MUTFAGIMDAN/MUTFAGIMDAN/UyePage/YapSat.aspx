<%@ Page Title="" Language="C#" MasterPageFile="~/UyePage/Profil.Master" AutoEventWireup="true" CodeBehind="YapSat.aspx.cs" Inherits="MUTFAGIMDAN.YapSat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="profile">
        <div style="font-size: 13px;" class="content">
            ...
            <asp:Button ID="ButtonGiris" runat="server" Text="Sat" CssClass="info" Style="color: #FFFFFF; background-color: #33CC33; margin-left: 14px;" Width="384px" OnClick="ButtonGiris_Click"/>
